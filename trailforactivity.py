...
#             print("File not found or could not be opened. Please enter a valid path.")
...
#     Maps the user's numerical choice to the column names.
#     Returns the selected column name.
#     """
#     print(f"Available columns: {', '.join(columns)}")
#     while True:
#         for i, column in enumerate(columns, 1):
#             print(f"{i} for {column}")
#         try:
#             choice = int(input("Please choose a numerical column by number: "))
#             if 1 <= choice <= len(columns):
#                 return columns[choice - 1]
#         except ValueError:
#             pass
#         print("Invalid choice. Please enter a number corresponding to the column.")

# def validate_numerical_data(data, columns, column_choice):
#     """
#     Validates that the data in the selected column is numerical.
#     Uses the column index to check the numerical data.
#     Returns a boolean indicating whether the data is numerical.
#     """
#     try:
#         column_index = columns.index(column_choice)
#         for row in data:
...
# def replace_empty_with_choice(data, column_choice, choice):
#     """
#     Replaces empty values in the data column based on the user's choice.
#     Uses the column index to work with numerical data.
...
#             row[column_index] = str(replacement_value)
#     return data

# def insertion_sort(data, column_index, descending=False):
#     """
#     Sorts the data using the insertion sort algorithm on the specified column.
#     Can sort in ascending (default) or descending order.
#     Returns the sorted data.
#     """
#     # ... no changes here ...

# def visualize_data(data, column_index):
#     """
#     Visualizes the data by printing '*' characters.
#     Each '*' represents 5 units of the value in the specified column.
#     """
#     # ... revise this function to work with column index ...

# def main():
#     # ... most of main function stays the same ...

#     while True:
#         column_choice = select_numerical_column(columns)
#         if validate_numerical_data(data, columns, column_choice):
#             break
#         else:

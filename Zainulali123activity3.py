'''Sayyed Zainul Abedin Ali has made the prompt_file_path function and part of the main function related to the prompt_file_path.
   Shaikha has made the validate_numerical_value function and part of main function related to it
   Natnael has made the insertion_sort load_csv_data  select_numerical_column replace_empty_with_choice visualize_data and the main functions'''
